  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-auto">
        <div className="p-4 border-b border-gray-300 dark:border-gray-600 flex items-center justify-between bg-gradient-to-r from-purple-600 to-blue-600">
        ...
        <div className="p-6">
          <div className="mb-4">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/30 dark:to-blue-900/30 border-2 border-purple-200 dark:border-purple-700 rounded-lg p-4">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-lg p-4 mb-6">
            <div className="flex gap-2">
              ...
              <div>
                <p className="text-sm font-medium text-blue-900 dark:text-blue-300 mb-1">AI Enhancement Applied</p>
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={onReject}
              className="px-6 py-3 bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-400 dark:focus:ring-gray-500 font-medium"
            >
              Keep Original
            </button>
          </div>
